...
public class Main {
	...
	public static void main(String[] args) {
		...
		try {
			switch (opcion) {
			case 1: 
				conexion.buscar(1, "libros");
				break;
			case 2: 
				conexion.buscar(2, "socios");
			break;
			case 3: 
				conexion.buscar(3, "prestamos");
			break;
			case 4: 
				conexion.buscar(4, "libros");
			break;
			case 5: 
				conexion.buscar(5, "libros");
			break;
			case 6: 
				conexion.buscar(6, "libros");
			break;
			case 7: 
				conexion.buscar(7, "socios");
			break;
			}
