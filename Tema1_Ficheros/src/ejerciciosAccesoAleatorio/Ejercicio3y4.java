...
public class Ejercicio3y4 {
	...
	static TreeSet<Departamento> departamentos;  //corresponde a la coleccion que almacena los datos leidos del binario
	...
	public static TreeSet<Departamento> crearDepartamentos() {
		TreeSet<Departamento> tempDepartamentos = new TreeSet<>();
		...
		do {
			...
			if (tempDepartamentos.add(departamento))
	...
	public static Departamento obtenerDepartamento (int numero) {
		...
		return buscadoDepart;
	}
	
	public static String mostrarDepartamentos () {
	...
	public static void main(String[] args) {
		...
		do {
			...
			case 1:
				try {
					departamentos = leerDepartamentos();
			...
			case 3:
				if (departamentos == null || departamentos.size() == 0) 
					...
					Departamento temporal = obtenerDepartamento(teclado.solicitarEnteroPositivo("introduce número de departamento. "));
					String datosTemporal = temporal.toString();
					temporal.setNombre(teclado.solicitarCadena("Escribe nombre departamento: "));
					temporal.setLocalidad(teclado.solicitarCadena("Escribe localidad: "));
			...
			case 4:
				if (departamentos == null || departamentos.size() == 0) 
					...
					if (departamentos.remove(obtenerDepartamento(teclado.solicitarEnteroPositivo("introduce número de departamento. "))))
